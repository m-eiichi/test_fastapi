...
from sqlalchemy import ARRAY, Boolean, CHAR, Column, Date, DateTime, Enum, CheckConstraint, ForeignKeyConstraint, Index, Integer, LargeBinary, Numeric, PrimaryKeyConstraint, SmallInteger, String, Table, Text, text
...
class Film(Base):
    __tablename__ = 'film'
    __table_args__ = (
        CheckConstraint('release_year >= 1900 AND release_year <= 2100', name='year_check'),
