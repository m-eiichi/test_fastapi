...
class Film(Base):
    ...
    release_year: Mapped[Optional[Any]] = mapped_column(DOMAIN('year', INTEGER(), constraint_name='year_check', not_null=False, check=<sqlalchemy.sql.elements.TextClause object at 0xffff9a73f890>))
